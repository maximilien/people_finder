...
# Move current to production and development to current
cp config/facebooker.yml config/facebooker.yml.production
cp config/facebooker.yml.development config/facebooker.yml

cp config/people_finder.yml config/facebooker.yml.production
cp config/people_finder.yml.development config/facebooker.yml