Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.rdoc", "Rakefile", "lib/hmac-md5.rb", "lib/hmac-rmd160.rb", "lib/hmac-sha1.rb", "lib/hmac-sha2.rb", "lib/hmac.rb", "test/test_hmac.rb"]
  s.has_rdoc = true
